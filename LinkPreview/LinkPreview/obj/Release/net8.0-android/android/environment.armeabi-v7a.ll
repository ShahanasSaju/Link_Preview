...
@dso_cache = dso_local local_unnamed_addr global [588 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 90630940, ; hash 0x566eb1c, from name: aot-LinkPreview.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1404227227, ; hash 0x53b2ce9b, from name: LinkPreview
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-LinkPreview.dll.so
		ptr null; void* handle (0x0)
	}, ; 185
	...
	%struct.DSOCacheEntry {
		i64 2455709274, ; hash 0x925f265a, from name: LinkPreview.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-LinkPreview.dll.so
		ptr null; void* handle (0x0)
	}, ; 332
	...
	%struct.DSOCacheEntry {
		i64 2582826833, ; hash 0x99f2cf51, from name: libaot-LinkPreview.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-LinkPreview.dll.so
		ptr null; void* handle (0x0)
	}, ; 348
	...
	%struct.DSOCacheEntry {
		i64 2870315060, ; hash 0xab158834, from name: aot-LinkPreview
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-LinkPreview.dll.so
		ptr null; void* handle (0x0)
	}, ; 394
	...
	%struct.DSOCacheEntry {
		i64 3977610958, ; hash 0xed1586ce, from name: libaot-LinkPreview
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-LinkPreview.dll.so
		ptr null; void* handle (0x0)
	}, ; 541
